    ...
    <section className="section">
      ...
      <div className="about">
        <div className="about__item">
          <img alt="image" className="about__img" src="https://img.icons8.com/pastel-glyph/64/000000/earth-planet.png"/>
        ...
        <div className="about__item">
          <img alt="image" className="about__img" src={itemImg}/>
          <h4 className="about__title">One Page</h4>
          <p className="about__text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor</p>
        </div>

        <div className="about__item">
          <img alt="image" className="about__img" src="https://img.icons8.com/ios/50/000000/national-park.png"/>
